...
This repo contains the data and bioinformatics scripts associated with generating the <i>Oculina arbuscula</i> transcriptome along with a less complete transcriptome of its endosymbiont Breviolum psygmophilum. 
